...
# Input Files 
# ----------------------------------------------------------   
InputFastq="../../../../Sequencing_data/ONT_sequencing_data/DNA-40.5Kb-DR-ONT-1.fastq" 
ReadLength=150
CorrThreshold=0.32                                                       # Correlation threshold
NumReadsList=("486") 

# ----------------------------------------------------------
# Process FASTQ File by Chunking Reads to Target Length
# ----------------------------------------------------------
OutputFastq="../sequencing_data/DNA-40.5Kb-DR-ONT-1-segment.fastq"    
