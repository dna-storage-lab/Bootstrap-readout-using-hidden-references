...
# Program Parameters
# ----------------------------------------------------------
WatermarkSeq="./configure/SequenceLengthALL_FILE001R025"
PayloadSize=40500
...
do
    ...
    (
        ...
        ./R0.25_bootstrap_recovery_step1.sh \
            "$SubReadsFile" \
            "$WatermarkSeq" \
            "$ExpDir_S1" \
            "$ReadLength" \
        ...
        if [ "$err1" -eq 0 ]; then
            ...
            ./R0.25_bootstrap_recovery_step2.sh \
                "$WatermarkSeq" \
                "$ExpDir_S2" \
                "$ReadLength" \
                "$ins" \
            ...
            if [ "$err2" -eq 0 ]; then
                ...
                ./R0.25_bootstrap_recovery_step3.sh \
                    "$SubReadsFile" \
                    "$WatermarkSeq" \
                    "$ExpDir_S3" \
                    "$ReadLength" \
