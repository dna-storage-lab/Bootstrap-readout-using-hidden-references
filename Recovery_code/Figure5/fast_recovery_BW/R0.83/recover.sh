...
# Program  Parameters
# ----------------------------------------------------------
WatermarkSeq="../configure/SequenceL81000NoPeriodOnly2ndFILE"      # Watermark sequence 
NumThreads=5                    
...
# ----------------------------------------------------------
# SE150
InputFastq="../../../../../Sequencing_data/ART_simulated_data/err_0.012/DNA-40.5Kb-MC-Sim-2.fastq"   # 150‑bp single‑end reads 
ReadLength=150
CorrThreshold=108                                                   # Correlation threshold
NumReadsList=("675")       # 2.5x
...
do
    ...
    do
        ...
        #   • WatermarkSeq                    – known watermark sequence
        # Outputs:
        #   • SoftInfoFile                    – soft info for LDPC decoder
