...
# ----------------------------------------------------------
# SE250
InputFastq="../../../../Sequencing_data/Illumina_sequencing_data/DNA-40.5Kb-DR-SE250.fastq"     # 250‑bp single‑end reads 
ReadLength=150
CorrThreshold=150                                                        # Correlation threshold
NumReadsList=("162")   #  0.6x
