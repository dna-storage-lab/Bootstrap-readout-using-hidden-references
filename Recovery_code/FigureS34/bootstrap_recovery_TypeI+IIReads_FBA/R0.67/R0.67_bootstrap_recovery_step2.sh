...
# ==========================================================
# R0.67_bootstrap_recovery_step2
# ==========================================================
...
awk '{print ">" NR; print}' "$outputDir/scaffold_ref.txt" > "$outputDir/scaffold_ref.fasta"

minimap2 -d "$outputDir/scaffold_ref.mmi" "$outputDir/scaffold_ref.fasta"

./bin/lowthres_pthread_minimap \
  "$NumThreads" \
  "$outputDir/scaffold_ref.mmi" \
  "$low_corr_reads" \
  "$TypeII_reads"
