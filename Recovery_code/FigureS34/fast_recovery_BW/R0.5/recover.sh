...
# Program  Parameters
# ----------------------------------------------------------
WatermarkSeq="../configure/sequenceL80640NoPeriod2FILE"                          # Watermark sequence 
NumThreads=5
...
# ----------------------------------------------------------
# SE150
InputFastq="../../../../../Sequencing_data/ART_simulated_data/err_0.012/DNA-40.32Kb-ER-Sim-2.fastq"   # 150‑bp single‑end reads             
ReadLength=150
CorrThreshold=108                                                                 # Correlation threshold
NumReadsList=("484")  # 1.8x
