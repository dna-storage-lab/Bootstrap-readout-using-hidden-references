...
# Program  Parameters
# ----------------------------------------------------------
WatermarkSeq="../configure/4w_pn"                                    # Watermark sequence 
NumThreads=5                    
...
# ----------------------------------------------------------
# SE150
InputFastq="../../../../Sequencing_data/ART_simulated_data/err_0.006/DNA-20Kb-RB-Sim-1.fastq"   # 150‑bp single‑end reads 
ReadLength=150
CorrThreshold=96                                                      # Correlation threshold
NumReadsList="1250"   #9.4x
