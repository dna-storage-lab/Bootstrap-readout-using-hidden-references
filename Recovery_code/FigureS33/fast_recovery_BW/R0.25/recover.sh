...
# Program  Parameters
# ----------------------------------------------------------
WatermarkSeq="../configure/SequenceLengthALL_FILE001R025"               # Watermark sequence 
NumThreads=1         
...
# ----------------------------------------------------------
# SE150
InputFastq="../../../../../Sequencing_data/ART_simulated_data/err_0.006/DNA-40.5Kb-DR-Sim-1.fastq"          # 150‑bp single‑end reads 
ReadLength=150
CorrThreshold=96                                                          # Correlation threshold
NumReadsList=("216")   #  0.8x
...
do
    ...
    # ../bin/SubsampleFastq  "$InputFastq" "$NumReads" "$ExpNum" "$SubDir"
    ...
    do
        ...
        OutputTextFile="${ExpDir}/recovery_poem.txt"
        ...
        #   • SoftInfoFile                     – from Step 2
        # Outputs:
        #   • OutputTextFile                   – reconstructed text 
